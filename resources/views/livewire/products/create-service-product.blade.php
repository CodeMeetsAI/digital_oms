    ...
    <form wire:submit.prevent="store">
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-4">
                    <div class="mb-3">
                        <label class="form-label required">SKU <span class="text-muted fw-normal">(Autogenerate <input type="checkbox" wire:model.live="sku_autogenerate">)</span></label>
                        <input type="text" class="form-control @error('code') is-invalid @enderror" wire:model.live="code" placeholder="SVC-123" @if($sku_autogenerate) readonly @endif>
                        @error('code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label required">Service Name</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" wire:model.live="name" placeholder="Service Name">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="#" class="text-success text-decoration-none fw-bold"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"/><path d="M20.385 6.585a2.1 2.1 0 0 0 -3.485 -1.573l-1.68 1.68l3.71 3.71l1.68 -1.68a2 2 0 0 0 -0.225 -2.137z"/><path d="M16 19l3.71 -3.71"/></svg> Add Taxes</a>
                    </div>
                    <div class="mb-3">
